...
<a href="{{ route('admin.dashboard') }}" class="flex items-center space-x-4 text-gray-700 hover:text-pink-600">
  ...
  <div class="flex-1 p-6">
    <!-- Toggle Button -->
    <h1 class="text-2xl font-bold text-[#AF1740]">Tambah Barang</h1>

    <div class="p-6 flex justify-center">
  <div class="w-full max-w-xl bg-white p-6 rounded-lg shadow-md">
    <h2 class="text-xl font-semibold text-gray-800 mb-6">Tambah Barang Baru</h2>
  ...
  <div class="flex items-center space-x-4">
    ...
    <input
      ...
      id="nama_barang"
      required
      class="flex-1 border border-gray-300 rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#AF1740]"
    />
  </div>
  ...
  <!-- Gambar -->
  <div class="flex items-center space-x-4">
    <label for="gambar" class="w-40 text-sm font-medium text-gray-700">Gambar:</label>
    <input
      type="file"
      name="gambar"
      id="gambar"
